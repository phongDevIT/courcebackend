...
function Header(props) {
  ...
  useEffect(() => {
    ...
    if (role === "435345345345345" && window.location.href.includes("Admin")) {
      setCheck('none')
    }
    else {
      setCheck('')
    }
  }, [role, token, window.location.href.toString()]);
  const handleLogout = () => {
    localStorage.clear();
    navigate("/");
  };
  ...
  return (
    <div className="adfghjkllllllllllldsfgd" style={{ display: check }}>
